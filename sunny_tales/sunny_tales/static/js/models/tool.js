Tool = Backbone.Model.extend({
	...
	initialize : function() {
		...
		var close_x = $("<div style='overflow: visible;'><img id=close_x class='close_x' src='/static/png/glyphicons_197_remove.png' style='position: absolute;display:none;top:-20px;cursor: pointer;'></div>")
